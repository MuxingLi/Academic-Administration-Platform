...
<html>
  <head>
    ...
    <title>My JSP 'selectApplyTech1.jsp' starting page</title>
...
<link href="Css/main.css" rel="stylesheet" type="text/css" />
  ...
  <form action="SelectApplyTech" method="post">
    ...
    <td><input type="text" name="atime" value="${requestScope.a1.time}" onclick="" /></td>
    <td align="center">使用时间： </td>
    <td><input type="text" name="ausetime" value="${requestScope.a1.usetime}" onclick="WdatePicker({el:$dp.$(this)})" /></td>    
    <td align="center">申请状态： </td>
    <td><input type="text" name="astatus" value="${requestScope.a1.status}"/></td>
...
<tr>
  <td colspan="7">
    ...
    <img src="Images/blank.jpg">
     <a style="color:#213541;" href="./SelectApplyTech?page=<%=1%>&atime=${requestScope.a1.time}&astatus=${requestScope.a1.status}&ausetime=${requestScope.a1.usetime}"><img src="Images/page_first_1.jpg"></a>&nbsp;
    <c:if test="${requestScope.currentCount>1}">
     <a style="color:#213541;" href="./SelectApplyTech?page=${requestScope.currentCount-1}&atime=${requestScope.a1.time}&astatus=${requestScope.a1.status}&ausetime=${requestScope.a1.usetime}"><img src="Images/page_back_1.jpg"></a>&nbsp;
	</c:if>
	<c:if test="${requestScope.currentCount<sumPageCount}">
     <a style="color:#213541;" href="./SelectApplyTech?page=${requestScope.currentCount+1}&atime=${requestScope.a1.time}&astatus=${requestScope.a1.status}&ausetime=${requestScope.a1.usetime}"><img src="Images/page_next.gif"></a>&nbsp;
    </c:if>
     <a style="color:#213541;" href="./SelectApplyTech?page=${requestScope.sumPageCount}&atime=${requestScope.a1.time}&astatus=${requestScope.a1.status}&ausetime=${requestScope.a1.usetime}"><img src="Images/page_last.gif"></a>
  </td>
  </tr>
  <tr>
