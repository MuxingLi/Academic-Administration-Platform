...
<html>
  <head>
    ...
    <title>My JSP 'selectCourseArrange.jsp' starting page</title>
...
<script type="text/javascript" language="javascript" src="Css/print.js"></script>
  ...
  <body>
  <form action="InsertCourseArrange1" method="post">
    <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center" >
      <tr height="20px">
        <td width="24%" style="border-width:0px;padding:0px">&nbsp;&nbsp;姓名：${requestScope.s.name} &nbsp;&nbsp;学号：${requestScope.s.id}</td>
  ...
  <tr>
  <td colspan="6" height="20px" style="font-size:10px;padding:0px">&nbsp;&nbsp;学号： ${requestScope.s.id}&nbsp;&nbsp;&nbsp;&nbsp;院系： ${requestScope.s.studepartment}&nbsp;&nbsp;&nbsp;&nbsp;姓名： ${requestScope.s.name}
  </td>
