...
<html>
  <head>
    <title>My JSP 'selectApply.jsp' starting page</title>
...
<script type="text/javascript" src="Css/My97DatePicker1/WdatePicker1.js"></script>
  ...
  <form action="SelectApplyAdmin" method="post">
    ...
    <td><input type="text" name="aname" value="${requestScope.a1.id}"/></td>
...
<tr>
  <td colspan="7">
    ...
    <img src="Images/blank.jpg">
     <a style="color:#213541;" href="./SelectApplyAdmin?page=<%=1%>&atime=${requestScope.a1.time}&aname=${requestScope.a1.id}&ausetime=${requestScope.a1.usetime}"><img src="Images/page_first_1.jpg"></a>&nbsp;
    <c:if test="${requestScope.currentCount>1}">
     <a style="color:#213541;" href="./SelectApplyAdmin?page=${requestScope.currentCount-1}&atime=${requestScope.a1.time}&aname=${requestScope.a1.id}&ausetime=${requestScope.a1.usetime}"><img src="Images/page_back_1.jpg"></a>&nbsp;
	</c:if>
	<c:if test="${requestScope.currentCount<sumPageCount}">
     <a style="color:#213541;" href="./SelectApplyAdmin?page=${requestScope.currentCount+1}&atime=${requestScope.a1.time}&aname=${requestScope.a1.id}&ausetime=${requestScope.a1.usetime}"><img src="Images/page_next.gif"></a>&nbsp;
    </c:if>
     <a style="color:#213541;" href="./SelectApplyAdmin?page=${requestScope.sumPageCount}&atime=${requestScope.a1.time}&aname=${requestScope.a1.id}&ausetime=${requestScope.a1.usetime}"><img src="Images/page_last.gif"></a>
  </td>
  </tr>
  <tr>
