...
<form action="SelectAllNewsServlet1" method="post">
  <table width="98%" border="0" align="center" style="margin-top:10px;margin-bottom:30px">
    <tr>
    <td width="70%"><input type="text" style="width:100%;border:0px" name="one" value="${requestScope.one}"/>
    </td>      
  ...
  <table width="98%" border="0" align="center">
	...
	<tr><td colspan="6" align="center">无符合条件的公告</td></tr>
    </c:if>
 	 <c:if test="${requestScope.stry1!=null}">
  ...
  <td colspan="8">
    ...
    <img src="Images/blank.jpg">
     <a style="color:#213541;" href="./SelectAllNewsServlet1?page=<%=1%>&one=${requestScope.one}"><img src="Images/page_first_1.jpg"></a>&nbsp;
    <c:if test="${requestScope.currentCount>1}">
     <a style="color:#213541;" href="./SelectAllNewsServlet1?page=${requestScope.currentCount-1}&one=${requestScope.one}"><img src="Images/page_back_1.jpg"></a>&nbsp;
	</c:if>
	<c:if test="${requestScope.currentCount<sumPageCount}">
     <a style="color:#213541;" href="./SelectAllNewsServlet1?page=${requestScope.currentCount+1}&one=${requestScope.one}"><img src="Images/page_next.gif"></a>&nbsp;
    </c:if>
     <a style="color:#213541;" href="./SelectAllNewsServlet1?page=${requestScope.sumPageCount}&one=${requestScope.one}"><img src="Images/page_last.gif"></a>
  </td>
  </tr>
  <tr>
