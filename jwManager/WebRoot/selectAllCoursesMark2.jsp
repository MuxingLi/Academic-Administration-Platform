...
<html>
  <head>
    ...
    <title>My JSP 'selectAllCoursesMark2.jsp' starting page</title>
...
<link href="Css/main.css" rel="stylesheet" type="text/css" />
 ...
 <table width="98%" border="1" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <td width="16%" align="center">查看成绩</td>
  </tr>
...
<c:if test="${requestScope.ctry1!=null}">
  ...
  <td colspan="6">
    ...
    <img src="Images/blank.jpg">
     <a style="color:#213541;" href="./SelectAllCoursesMark2?page=<%=1%>"><img src="Images/page_first_1.jpg"></a>&nbsp;
    <c:if test="${requestScope.currentCount>1}">
     <a style="color:#213541;" href="./SelectAllCoursesMark2?page=${requestScope.currentCount-1}"><img src="Images/page_back_1.jpg"></a>&nbsp;
	</c:if>
	<c:if test="${requestScope.currentCount<sumPageCount}">
     <a style="color:#213541;" href="./SelectAllCoursesMark2?page=${requestScope.currentCount+1}"><img src="Images/page_next.gif"></a>&nbsp;
    </c:if>
     <a style="color:#213541;" href="./SelectAllCoursesMark2?page=${requestScope.sumPageCount}"><img src="Images/page_last.gif"></a>
  </td>
  </tr>
  <tr>
    <td colspan="6" align="center"><a href="blank.jsp"><input id="btn_loca" type="button" value="返回"/></a></td>
    </tr>
</table>
</form>
  </body>
