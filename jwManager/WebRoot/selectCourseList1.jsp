...
<html>
  <head>
    ...
    <title>My JSP 'selectCourseList1.jsp' starting page</title>
...
<link href="Css/main.css" rel="stylesheet" type="text/css" />
  ...
  <body>
  <form action="SelectCourseList1" method="post">
 ...
 <table width="98%" border="1" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <td width="16%" align="center">查看名单</td>
  </tr>
<c:if test="${requestScope.ctry1!=null}">
  ...
  <tr>
    ...
    <td align="center"><a style="color:#213541;" href="SelectStudentList?cid=${temp.cid}"><img src="Images/114.gif" width="14" height="14" />查看名单</a></td>
  </tr>
   </c:forEach>
</c:if>
  <tr>
  <td colspan="6">
    ...
    <img src="Images/blank.jpg">
     <a style="color:#213541;" href="./SelectCourseList1?page=<%=1%>&cryear=${requestScope.c1.cyear}&crterm=${requestScope.c1.cterm}&crexam=${requestScope.c1.cexam}"><img src="Images/page_first_1.jpg"></a>&nbsp;
    <c:if test="${requestScope.currentCount>1}">
     <a style="color:#213541;" href="./SelectCourseList1?page=${requestScope.currentCount-1}&cryear=${requestScope.c1.cyear}&crterm=${requestScope.c1.cterm}&crexam=${requestScope.c1.cexam}"><img src="Images/page_back_1.jpg"></a>&nbsp;
	</c:if>
	<c:if test="${requestScope.currentCount<sumPageCount}">
     <a style="color:#213541;" href="./SelectCourseList1?page=${requestScope.currentCount+1}&cryear=${requestScope.c1.cyear}&crterm=${requestScope.c1.cterm}&crexam=${requestScope.c1.cexam}"><img src="Images/page_next.gif"></a>&nbsp;
    </c:if>
     <a style="color:#213541;" href="./SelectCourseList1?page=${requestScope.sumPageCount}&cryear=${requestScope.c1.cyear}&crterm=${requestScope.c1.cterm}&crexam=${requestScope.c1.cexam}"><img src="Images/page_last.gif"></a>
  </td>
  </tr>
  <tr>
