...
public class SelectAllCoursesServlet extends HttpServlet {
	 ...
	 */
	public SelectAllCoursesServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Course> slist = dao.fenye(currentCount);//分页
		if(slist.size()==0){
			slist=null;
		}
		...
		request.getRequestDispatcher("selectAllCourses.jsp").forward(request, response);
	}
