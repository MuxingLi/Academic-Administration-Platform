...
public class AcceptApplyServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ra.setStatus(status);
		int i=dao.updateStatusAccept(ra);
		if(i>0){
			out.println("<script language=javascript>");				
			out.println("alert('同意申请成功');");	
