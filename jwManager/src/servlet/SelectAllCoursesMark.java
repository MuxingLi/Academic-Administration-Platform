...
public class SelectAllCoursesMark extends HttpServlet {
...
//		ArrayList<TeacherCourse> tc=tcdao.selectAllCoursesByTname(tname);
//		request.setAttribute("tcourses", tc);
		...
		request.getRequestDispatcher("selectAllCoursesMark.jsp").forward(request, response);
	}
